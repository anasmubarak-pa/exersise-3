function camelSnake(word)
{
    ...
    for(let i=1;i<word.length;i++)
    {
        ...
        {
            word = word.slice(0,i).concat('_').concat(word[i]).concat(word.slice(i+1,word.length))
            i++
        }
    }
...
testProgram(camelSnake,[input1,input2,input3,input4,input5,input6,input7,input8,input9,input10,
