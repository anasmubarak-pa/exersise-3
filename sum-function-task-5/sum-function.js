function sumFunction(...args)
{
    ...
    return typeof result ==='number'?(isNaN(Number(result))?'Invalid arguments':result):'Invalid arguments'
}
...
testProgram(sumFunction,[input1,input2,input3,input4,input5,input6,input7,input8,input9,input10,
